...
Added a fscale keyword for kspace pppm and pppm/tip4p styles to adapt only the forces during MD simulations. Also
added the possibility to adapt angle potential (such as angle_harmonic that is used in the examples) by
Rodolfo Paula Leite (Unicamp/BR)
------------------------------------------------------------------------- */
...
class FixAdapt : public Fix {
 ...
 private:
  int nadapt, resetflag, scaleflag, massflag, fscaleflag;
